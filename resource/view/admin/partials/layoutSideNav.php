            ...
            <div class="nav">
                ...
                if ($xem_sp == true):
                    ...
                    <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne"
                         data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="manage-products.php">Quản lý đồ án</a>
                        </nav>
                    </div>
                    <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne"
                         data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="manage-product_categories.php">Quản lý giảng viên</a>
                        </nav>
                    </div>
                    <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne"
                         data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="manage-product_tags.php">Quản lý khoa</a>
                        </nav>
                    </div>
                <?php
                endif;
                ...
                if ($xem_sp == true):
                    ?>
                    <div class="sb-sidenav-menu-heading">Quyền</div>
