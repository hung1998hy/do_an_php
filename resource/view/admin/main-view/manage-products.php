...
<head>
    ...
    <title>Quản lý đồ án và bài tập lớn</title>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Thêm đồ án hoặc bài tập lớn</h5>
        ...
        <div class="modal-content">
            <form action="../product/editProduct.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="productCategoryUpdate">Tên giảng viên</label>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Quản lý đồ án và bài tập lớn</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">Quản lý đồ án và bài tập lớn </li>
                </ol>
                <?php
                ...
                if ($xem_sp == true):
                    ...
                    <button data-toggle="modal" data-target="#productAddModal"
                            class="btn btn-primary addBtn">Thêm đồ án hoặc bài tập lớn
                    </button>
                <?php
                endif;
                ?>
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        Danh sách đồ án và bài tập lớn
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <td class="productImgtd text-center">
                                            <a href="<?php echo $row['images']; ?>"> <?php echo pathinfo($row['images'], PATHINFO_BASENAME)?></a>
                                        </td>
